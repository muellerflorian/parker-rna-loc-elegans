...
p1 <- ggplot(plot_data, aes(Condition, X._clusters_in_Pgran*100, fill=Condition)) +
  geom_boxplot(position=position_dodge(0.8), outlier.shape = NA) +
  geom_point(position=position_jitterdodge(dodge.width=0.8), alpha = 0.5) +
  ylim(c(0, 100))+
  annotate(geom="text", x=1.5, y=80, label=pvalue_1, color="#66CCCC")+
...
p2 <- ggplot(plot_data, aes(Condition, X._clusters_in_Pgran*100, fill=Condition)) +
  geom_boxplot(position=position_dodge(0.8), outlier.shape = NA) +
  geom_point(position=position_jitterdodge(dodge.width=0.8), alpha = 0.5) +
  ylim(c(0, 100))+
  annotate(geom="text", x=1.5, y=80, label=pvalue_2, color="#66CCCC")+
...
p3 <- ggplot(plot_data, aes(Condition, X._clusters_in_Pgran*100, fill=Condition)) +
  geom_boxplot(position=position_dodge(0.8), outlier.shape = NA) +
  geom_point(position=position_jitterdodge(dodge.width=0.8), alpha = 0.5) +
  ylim(c(0, 100))+
  annotate(geom="text", x=1.5, y=80, label=pvalue_3, color="#66CCCC")+
...
filename <- paste( date, "_output_plots_Fig7B.pdf", sep = "")
#export pdf
...
plot_data <- clusterTable %>%
    filter(Probe == "gpd-2", Condition == "HS")

plot_data2 <- clusterTable %>%
    filter(Probe == "gpd-2", Condition == "No_HS")

t.test(plot_data$X._clusters_in_Pgran, plot_data2$X._clusters_in_Pgran)
